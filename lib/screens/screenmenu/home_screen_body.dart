...
class _HomeScreenBodyState extends State<HomeScreenBody> {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Padding( // เพิ่ม Padding 20.0 ภายใน Container
                  ...
                  children: [
                    ...
                    Row( 
                      ...
                      children: [
                        ...
                        const SizedBox(width: 20), // ตัวเว้นระยะห่างระหว่างรูปกับข้อความ
                    ...
                    Container(
                      ...
                      padding: const EdgeInsets.all(10.0), // เพิ่มระยะห่างภายในกรอบ
                      ...
                      child:  Row(
                        children: [
                          Row(
                            ...
                            children: [
                              Image.asset('assets/icons/cash.png', width: 40, height: 40),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Image.asset('assets/icons/tip.png', width: 40, height: 40),
                              const SizedBox(width: 10),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
  ...
  Widget _buildJobStatusWidget() {
    ...
    if (employee.status == EmploymentStatus.isHired && employee.currentJob != null) {
      // ----------------------------------------------------
...
return Container(
  ...
  decoration: BoxDecoration(
    color: Theme.of(context).colorScheme.secondary, // ใช้สีพื้นหลังเดียวกับปุ่ม
    borderRadius: BorderRadius.circular(10), // อาจเพิ่มมุมโค้งมนเพื่อให้ดูคล้ายปุ่ม
...
Map<String, List<HistoryItem>> _groupHistoryByDate(List<HistoryItem> records) {
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: const TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.bold,
                        color: Color.fromRGBO(56, 139, 18, 1), // สีเขียวตามภาพ
                      ),
                    ),
                  ],
                ),
